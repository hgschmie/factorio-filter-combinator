...
Writing even a small mod takes some organization to not end up with complicated and brittle code. This mod is also a testbed to try out some different techniques on how to structure a mod:
